...
USAGE = (
    ...
    "答题消息中普通成员显示姓名，匿名管理员只显示管理员标签；未收到奖励时先以个人账号在群里发言，再点击“申请补发奖励”，平台会校验状态并避免重复发放。"
    ...
    "properties": {
        "usage_preview": {
            ...
            "default": (
                ...
                "12. 答题消息中普通成员显示姓名，匿名管理员只显示管理员标签；未收到奖励时先以个人账号在群里发言，再点击“申请补发奖励”，平台会校验状态且不会重复发放。答错后的新答案按钮有 2 秒冷却，连点不会消耗答题机会。\n"
