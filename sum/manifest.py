...
CONFIG_SCHEMA = {
    ...
    "properties": {
        ...
        "ai_usage_guide": {
            ...
            "default": "sum 只调用 TelePilot 已配置的 AI Provider；普通使用保持自动路由即可。需要固定时可在下方选择 Provider 和模型。",
            "readOnly": True,
        },
        "telepilot_provider": {
            "type": "string",
...
MANIFEST = Manifest(
    ...
    permissions=["send_message", "edit_message", "read_chat", "resolve_entity", "ai_text", "send_file"],
    category="utility",
    interaction_entries=[],
